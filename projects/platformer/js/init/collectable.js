(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.max, 700, 70, 7, 0.7);
        collectable.create(type.grace, 750, 500, 8, 0.7);
        collectable.create(type.grace, 400, 20, 8, 0.7);
        collectable.create(type.kennedi, 600, 170, 2, 0.7);
